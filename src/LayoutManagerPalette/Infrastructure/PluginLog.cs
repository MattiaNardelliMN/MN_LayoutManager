...
namespace LayoutManagerPalette.Infrastructure
{
    ...
    /// </summary>
    /// <remarks>
    /// Percorso dei log: %AppData%\LayoutManagerPalette\logs\
    /// </remarks>
    public static class PluginLog
    {
        private const string PluginFolderName = "LayoutManagerPalette";
        ...
        public static string GetTodayLogFilePath()
        {
            string fileName = string.Format(
                ...
                "LayoutManagerPalette_{0:yyyy-MM-dd}.log",
                DateTime.Now);
        ...
        private static void RemoveOldLogFiles()
        {
            ...
            try
            {
                ...
                foreach (string file in Directory.GetFiles(LogDirectory, "LayoutManagerPalette_*.log"))
                {
