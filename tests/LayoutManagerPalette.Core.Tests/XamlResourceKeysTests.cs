...
namespace LayoutManagerPalette.Core.Tests
{
    ...
    public class XamlResourceKeysTests
    {
        ...
        private static string ThemePath => Path.Combine(GetSourceRoot(), "LayoutManagerPalette", "Themes", "DarkTheme.xaml");

        private static string ViewPath => Path.Combine(GetSourceRoot(), "LayoutManagerPalette", "UI", "LayoutPaletteView.xaml");
